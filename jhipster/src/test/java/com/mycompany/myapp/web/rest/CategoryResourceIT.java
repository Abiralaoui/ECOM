...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().idCategory(DEFAULT_ID_CATEGORY).nom(DEFAULT_NOM);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().idCategory(UPDATED_ID_CATEGORY).nom(UPDATED_NOM);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getNom()).isEqualTo(DEFAULT_NOM);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.idCategory(UPDATED_ID_CATEGORY).nom(UPDATED_NOM);
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(testCategorySearch.getIdCategory()).isEqualTo(UPDATED_ID_CATEGORY);
                assertThat(testCategorySearch.getNom()).isEqualTo(UPDATED_NOM);
            });
    }
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.idCategory(UPDATED_ID_CATEGORY);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.idCategory(UPDATED_ID_CATEGORY).nom(UPDATED_NOM);
