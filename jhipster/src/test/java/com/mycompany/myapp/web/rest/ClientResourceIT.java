...
class ClientResourceIT {
    ...
    public void cleanupElasticSearchRepository() {
        ...
        assertThat(clientSearchRepository.count()).isEqualTo(0);
    }
    ...
    void putExistingClient() throws Exception {
        ...
        await()
            ...
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(clientSearchRepository.findAll());
                assertThat(searchDatabaseSizeAfter).isEqualTo(searchDatabaseSizeBefore);
                List<Client> clientSearchList = IterableUtils.toList(clientSearchRepository.findAll());
                Client testClientSearch = clientSearchList.get(searchDatabaseSizeAfter - 1);
                assertThat(testClientSearch.getIdentifiant()).isEqualTo(UPDATED_IDENTIFIANT);
                assertThat(testClientSearch.getMotDePasse()).isEqualTo(UPDATED_MOT_DE_PASSE);
                assertThat(testClientSearch.getTel()).isEqualTo(UPDATED_TEL);
                assertThat(testClientSearch.getAddress()).isEqualTo(UPDATED_ADDRESS);
            });
    }
